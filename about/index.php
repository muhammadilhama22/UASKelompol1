                ...
                <div class="card-body">
                  <table id="about" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                    ...
                    <tbody>
                      <?php
                      include '../../koneksi.php';
                      $query = mysqli_query($koneksi, "SELECT * From tb_about ORDER BY id DESC");
                      $no = 1;
                              ...
                              <div class="modal-body">
                                ...
                                <div class=" card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="judul" id="judul" class="form-control" value="<?= $result['judul']; ?>" required disabled>
                                  </div>
                                  <div class="form-group">

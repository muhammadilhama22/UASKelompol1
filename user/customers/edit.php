...
$col_password = $result['col_password'];
$col_status = $result['col_status'];
//
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <div class=" card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="col_password" id="col_password" class="form-control" value="<?= $col_password ?>" required>
                                        </div>

                                        <div class="form-group">
                                            <input type="hidden" name="col_status" value="<?= $col_status ?>" required>
                                        </div>

                ...
                <div class="card-body">
                  <table id="about" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                    ...
                    <tbody>
                      <?php
                      include '../../koneksi.php';
                      $query = mysqli_query($koneksi, "SELECT * From tb_penulis ORDER BY id DESC");
                      $no = 1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="text-center">
                            <img alt="Avatar" class="table-avatar rounded-circle img-bordered " style="object-fit: cover;" src="uploads/<?= $result['gambar']; ?>" width="100px" height="100px">
                          </td>
                            ...
                            <div class="modal-content bg-primary ">
                              ...
                              <div class="modal-body">
                                ...
                                <div class=" card-body d-flex flex-column justify-content-center align-items-center">
                                  <img src="uploads/<?= $result['gambar']; ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px" style="object-fit: cover;">

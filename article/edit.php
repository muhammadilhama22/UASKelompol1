                                ...
                                <form action="proses_edit.php" method="POST" enctype="multipart/form-data"">
                                    ...
                                    <div class=" card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="isi" name="isi" class="form-control" rows="4" required><?= $isi ?></textarea>
                                        </div>

                                        <?php $query = mysqli_query($koneksi, "SELECT * FROM tb_kategori ORDER BY id DESC"); ?>
                                        <div class="form-group">
                                        ...
                                        <?php $query = mysqli_query($koneksi, "SELECT * FROM tb_penulis ORDER BY id DESC"); ?>
                                        <div class="form-group">
                                            <label for="nama_penulis">Nama Penulis</label>
                                            <select id="nama_penulis" name="nama_penulis" class="form-control custom-select" required>
                                                <option selected disabled>Choose One :</option>
                                                <?php while ($result = mysqli_fetch_array($query)) { ?>
                                                    <option value="<?= $result['id']; ?>"><?= $result['nama_penulis']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>

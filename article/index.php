                ...
                <div class="card-body">
                  <table id="about" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                    ...
                    <tbody>
                      ...
                      INNER JOIN tb_penulis ON tb_artikel.id_penulis = tb_penulis.id
                      INNER JOIN tb_merek ON tb_artikel.id_merek = tb_merek.id
                      ORDER BY id DESC
                      ");
                      while (
                        $result =
                              ...
                              <div class="modal-body">
                                ...
                                <div class=" card-body">
                                  ...
                                  <center><img src="uploads/<?= $result['gambar']; ?>" style="object-fit: cover;" alt="" class="rounded-circle" width="200px" height="200px">
                                    <h3 class="mt-3"><?= $result['judul']; ?></h3>
                                  </center>

                                  <div class="date float-right "><?= $result['created_at']; ?></div>
                                  <div class="form-group mt-3">
                                    <textarea id="isi" name="isi" class="form-control" rows="4" required disabled><?= $result['isi']; ?></textarea>
                                  </div>

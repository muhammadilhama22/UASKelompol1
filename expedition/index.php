                ...
                <div class="card-body">
                  <table id="about" class="table table-striped table-bordered dt-responsive nowrap" style="width: 100%">
                    ...
                    <tbody>
                      <?php
                      include '../../koneksi.php';
                      $query = mysqli_query($koneksi, "SELECT * From tb_ekspedisi ORDER BY id DESC");
                      $no = 1;
                            ...
                            <div class="modal-content bg-primary ">
                              ...
                              <div class="modal-body">
                                ...
                                <div class=" card-body d-flex flex-column justify-content-center align-items-center">
                                  <img src="uploads/<?= $result['gambar']; ?>" alt="" class="rounded-circle" width="200px" height="200px" style="object-fit: cover;">
